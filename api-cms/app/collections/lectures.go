...
func (u *Lecture) CollectionName() string {
	return "lectures"
}

func (u *Lecture) Find(filter interface{}, opts ...*options.FindOptions) (Lectures, error) {
	ctx, cancel := context.WithTimeout(context.Background(), QueryTimeOut)
	defer cancel()
	data := make(Lectures, 0)
...
func (u *Lecture) First(filter interface{}) error {
	ctx, cancel := context.WithTimeout(context.Background(), QueryTimeOut)
	defer cancel()
...
func (u *Lecture) Count(filter bson.M) (int64, error) {
	ctx, cancel := context.WithTimeout(context.Background(), QueryTimeOut)
	defer cancel()
