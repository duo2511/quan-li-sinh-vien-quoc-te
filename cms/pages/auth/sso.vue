      ...
      <a-card style="margin-top: 3rem">
        <div class="text-center">
          ...
          <h2 class="color-primary mt-20 mb-30">
            HỆ THỐNG QUẢN LÝ QUỐC GIA VỀ ĐĂNG KÝ, CẤP PHÉP HÀNH NGHỀ KHÁM BỆNH, CHỮA BỆNH
          </h2>
          ...
          <div v-else>
            <template>
              ...
              <div>
                <a-button type="success" class="ant-btn" @click.prevent="CloseWindow" :loading="true"
                  >Chuyển hướng sau <span>&nbsp; {{ entry.countdown }} giây</span></a-button
                >
              </div>
            </template>
          </div>
