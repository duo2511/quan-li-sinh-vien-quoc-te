<template>
  <div>
    ...
    <p>CNTT : {{ countClassesByDepartment('CNTT') }}</p>
    <p>ATTT : {{ countClassesByDepartment('ATTT') }}</p>
    <p>CN Đa Phương Tiện : {{ countClassesByDepartment('CN Đa Phương Tiện') }}</p>
